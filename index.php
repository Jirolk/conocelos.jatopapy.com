        ...
        <div class="  align-items-center">
          <ul>
            ...
            <li class="text-center font-weight-bold text-dark">
              Si te gustaria formar parte de nuestra Base de Datos y que la ciudadanía te conozca con tu propuesta electoral, <a class="btn badge badge-info text-white mt-2 mb-2" onclick="contactanos();">Contacta con Nosotros! <img src="img/wtp.png" width="20" height="20" alt="wtp"></a>
