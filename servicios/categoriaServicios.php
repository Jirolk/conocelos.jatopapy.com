<?php
    ...
    require("conexion.php");
     ...
     if ($opc == "N"){	//NUEVO
          $grabar = true;
          $sql = "SELECT categoria FROM categorias WHERE categoria ILIKE '$ciudad' ";
          ...
          if($grabar == true){
               $sql = "INSERT INTO categorias (categoria) VALUES ('$ciudad')";
          ...
          $grabar = true;
      		...
      		if ($grabar == true){
      			$sql = "UPDATE categorias SET categoria='$ciudad' WHERE idcategoria='$id'";
      			$resul = pg_query($conex, $sql);
                    cerrarBD($conex);
      			echo 5;
      		}
