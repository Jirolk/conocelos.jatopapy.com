...
class PDF extends FPDF{
     function Header(){
          ...
          $this->Cell(170, 6, utf8_decode('DEOCREACIONES'),0,2,'C');
          $this->SetFont('Arial','B', 10);
          $this->SetX($margenIzquierdo);
          $this->Cell(170, 4, utf8_decode('Tte. Cabrera c/ Don Bosco y Sarmiento'),0,2,'C');
          $this->SetX($margenIzquierdo);
          $this->Cell(170, 4, utf8_decode('Concepción - Paraguay'),0,2,'C');
          $this->SetX($margenIzquierdo);
          $this->SetFont('Arial','B', 18);
          $this->Cell(170, 7,'FACTURA - COMPRA','B',2,'C');
          $this->Image('../img/logoDeo2.png' , 25 ,5, 35 , 25,'PNG', '');
          $this->Image('../img/logoDeo2.png' , 150 ,5, 35 , 25,'PNG', '');
